export default function Cards(props) {
    ...
    return (
        <div className="card">
            <img src={props.imageUrl} className="pictureLocation" />
            <div className="description">
                <div className="location">
                    <svg className="locationPict" width="7" height="10" viewBox="0 0 7 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a target="_blank" href={props.googleMapsUrl} className="locationLink">View on Google Maps</a>
